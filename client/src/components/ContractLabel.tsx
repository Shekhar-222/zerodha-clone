    ...
    <span className={className}>
      ...
      {parts.isWeekly && (
        <>
          ...
          <span className="inline-flex h-3.5 w-3.5 items-center justify-center rounded-full bg-link/15 align-middle text-[10px] font-semibold leading-none text-link">
            W
          </span>{" "}
        </>
      )}
